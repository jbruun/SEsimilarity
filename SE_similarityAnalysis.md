...
## Make respondent similarity networks
    ...
    ## label.family, : font "Times-Roman" could not be found for family "serif"
...
## Characterise Super Groups
    ...
    ## axis.lty, : no font could be found for family "Arial"
    ...
    ## Warning in title(main = main, sub = sub, xlab = xlab, ylab = ylab, ...): no font
    ## could be found for family "Arial"
    ...
    ## Warning in axis(if (horiz) 1 else 2, cex.axis = cex.axis, ...): no font could be
